...
namespace Flecs.Tests
{
    ...
    public unsafe class SystemOnFrame : AbstractTest
    {
        ...
        private static void test_abort()
        { }

        private static void Iter(ref Rows rows)
        {
        ...
        private static void TestIsSharedOnNotSet(ref Rows rows)
        {
