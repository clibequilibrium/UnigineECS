...
namespace Flecs.Tests
{
    ...
    {
        private int CompreInt(void* p1, void* p2)
        {
            var v1 = *(int*)p1;
            var v2 = *(int*)p2;
        ...
        private VectorParams ArrParams = new VectorParams { elementSize = (uint)Heap.SizeOf<int>() };

        private Vector* FillArray(Vector* array)
        {
            int* elem;
        ...
        private void Vector_setup() => ecs.os_set_api_defaults();
